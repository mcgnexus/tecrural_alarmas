    ...
    <>
      {!abierto ? (
        <button
          type="button"
          onClick={abrir}
          className="fixed bottom-20 right-4 z-30 inline-flex min-h-[52px] items-center gap-2 rounded-full border-2 border-brand-800 bg-brand-800 px-5 py-3 text-base font-bold text-white shadow-lg hover:bg-brand-900"
        >
          💬 ¿Te ayudo?
        </button>
      ) : null}
      ...
      {abierto ? (
        <div className="fixed bottom-20 right-4 z-30 flex max-h-[70vh] w-[calc(100vw-2rem)] max-w-sm flex-col rounded-2xl border-2 border-stone-900 bg-white shadow-xl">
