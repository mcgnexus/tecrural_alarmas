  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-4 px-4 py-6">
      ...
      <section className="rounded-2xl border-2 border-stone-200 bg-white p-5 text-sm leading-relaxed text-stone-700">
        <p>
          Esta política describe el tratamiento de datos en la experiencia pública de TecRural Campo: consulta del tiempo por municipio, selección de cultivo y solicitud de avisos gratuitos por WhatsApp. La consulta meteorológica no requiere crear una cuenta. Cuando se envía el formulario de avisos, se activa el envío de avisos al WhatsApp que indiques y se guarda una referencia de la parcela y la suscripción en este navegador/dispositivo para reconocerla al volver. Se aplica conforme al Reglamento (UE) 2016/679 (RGPD), la Ley Orgánica 3/2018 (LOPDGDD), la Ley 34/2002 (LSSI-CE) y demás normativa aplicable.
        </p>
        ...
        <ul className="mt-1 list-disc space-y-1 pl-5">
          ...
          <li>Identificador seudónimo del dispositivo y cookie técnica de sesión firmada, que guardan una referencia en este navegador para reconocer la parcela y la suscripción al volver. Los avisos llegan al WhatsApp que escribas, no al teléfono desde el que navegas. La portada no exige crear una cuenta.</li>
        ...
        <p className="mt-1">Al seleccionar un municipio, las coordenadas asociadas se usan en el servidor para consultar y calcular el tiempo y, si activas avisos, para crear la parcela de referencia de la suscripción. No solicitamos la ubicación GPS del dispositivo ni mostramos las coordenadas como perfil público. La selección se guarda en el almacenamiento local del navegador y se guarda una referencia de la parcela y suscripción en este navegador. Los avisos llegan al WhatsApp que indiques. Si cambias de móvil, usas otro navegador o borras los datos del sitio, esa referencia local se pierde pero los avisos seguirán llegando a ese número hasta que pidas la baja. Puedes pedir su eliminación o desactivación escribiendo al correo indicado en esta política.</p>
        ...
        <p className="mt-1">La web guarda en el almacenamiento local el identificador seudónimo del dispositivo, el municipio elegido y el cultivo para recordar tu selección y reconocer la referencia de la suscripción. Utiliza además una cookie de sesión técnica, protegida y necesaria para reconocer ese navegador en las peticiones al servidor; la cookie tiene una duración máxima de un año. Los avisos llegan al WhatsApp que indiques, sin necesidad de mantener este navegador abierto. Si borras los datos del sitio o cambias de navegador/dispositivo, se pierde la referencia local pero los avisos siguen llegando al número indicado hasta que pidas la baja; puedes volver a activar la referencia desde el formulario. Puedes borrar el almacenamiento desde la configuración del navegador.</p>
